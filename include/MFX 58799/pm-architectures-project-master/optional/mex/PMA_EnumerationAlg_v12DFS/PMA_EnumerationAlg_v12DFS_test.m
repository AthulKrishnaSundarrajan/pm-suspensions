...
%--------------------------------------------------------------------------
function PMA_EnumerationAlg_v12DFS_test
...
% original
[output11,output12] = PMA_EnumerationAlg_v12DFS(V,E,SavedGraphs,id,...
    cVf,Vf,iInitRep,Am,Bflag,B,Mflag,M,displevel);
...
try
    % run mex version
    tic
    [output21,output22] = PMA_EnumerationAlg_v12DFS_mex(V,E,SavedGraphs,id,...
        cVf,Vf,iInitRep,Am,Bflag,B,Mflag,M,displevel);
    if displevellocal, toc, end
